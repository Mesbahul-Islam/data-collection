import requests
import pandas as pd
from riot_api.transform import clear_env_vars
from riot_api import fetch
...
#clear preloaded environment variables
clear_env_vars()
    ...
    for match in match_data:
        ...
        for participant in participants:
            try:
                ...
                print(f"Missing key {e} in participant data, skipping.")
